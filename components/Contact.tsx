    ...
    return (
        <motion.div
            ...
            <div className='py-4 gap-8'>
                <h3 className='flex font-titleFont md:text-xl text-md font-semibold items-center uppercase tracking-[10px] md:tracking-[20px] text-textGreen '>Get In Touch</h3>
            </div>

            <div className='flex flex-col md:space-y-10 space-y-6' >
                <h4 className='text-md md:text-2xl pt-6 font-semibold text-center'>Whether you have an idea for a project or just want to chat,{' '}<span className='decoration-textGreen/50 underline'>feel free to shoot me an email!</span></h4>
