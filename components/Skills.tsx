...
const Skills: React.FC<Props> = ({ directionLeft }) => {
  return (
    ...
    >
      ...
      <div className='w-full absolute top-[25%] md:top-[22%] lgl:top-[30%] md:w-10/12 bg-textGreen/30 rounded-md left-0 h-[550px] md:h-[600px] lgl:h-[400px] lgl:skew-x-0 z-0' />
    </motion.div>
  );
};
