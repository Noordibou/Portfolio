            ...
            <div className='flex items-center justify-between px-4 py-3'>
                ...
                >
                    <ul className='flex flex-col items-center font-titleFont font-semibold gap-4 px-8 py-8 text-bgColor  cursor-pointer '>
                        ...
                        <Link className='py-2 px-4 font-titleFont rounded-md border border-textBright hover:bg-textBright/30 flex items-center justify-between uppercase text-textDark cursor-pointer' href='/noor-dibou.pdf' target='_blank' >Resume</Link>
                    </ul>
                </div>
                <motion.ul
                    initial={{ x: 500, opacity: 0, scale: 0.5 }}
                    ...
                    <Link href='/noor-dibou.pdf' target='_blank' >
                        <motion.button
                            initial={{ x: 500, opacity: 0, scale: 0.5 }}
                            animate={{ x: 0, opacity: 1, scale: 1 }}
                            transition={{ duration: 1.5 }}
