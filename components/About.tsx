        ...
        <div className='flex flex-col lgl:flex-row gap-10'>
          <div>
            ...
            <p className='text-xs md:text-lg font-bodyFont text-textDark'>I started out studying biochemistry in college - I&apos;ve always loved learning how the natural world works on a molecular level. But I also realized I have a knack for programming and software engineering.
              ...
              <br></br>
              <br></br>
              I believe technology and environmentalism go hand in hand. There&apos;s so much potential when people from different backgrounds come together. I&apos;m always eager to collaborate and brainstorm new ideas. So let me know - what projects could we work on together to make this world a little greener?
            </p>
          </div>
        </div>
      </motion.div>
